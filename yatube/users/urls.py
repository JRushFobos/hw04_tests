...
urlpatterns = [
    ...
    # Смена пароля password_change_form.html
    path(
        'password_change/',
        PasswordChangeView
        .as_view(template_name='users/password_change_form.html'),
        name='password_change'),
    # Сообщение об успешном изменении пароля password_change_done.html
    path(
        'password_change/done/',
        PasswordChangeDoneView
        .as_view(template_name='users/password_change_done.html'),
        name='password_change_done'),
    # Восстановление пароля password_reset_confirm.html
    path(
        'password_reset/',
        PasswordResetView
    ...
    # Сообщение об успешном восстановлении пароля password_reset_complete.html
    path(
        'reset/done/',
        PasswordResetCompleteView
